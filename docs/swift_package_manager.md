...
| REVUP                            | 1.0.0 |
| REVUPCore                        | 1.0.0 |
| REVUPLuckyEvent                  | 1.0.0 |
| REVUPMediaAdManager              | 1.0.0 |
| REVUPMediaAdMob                  | 1.0.0 |
| REVUPMediaChartBoost             | 1.0.0 |
| REVUPMediaPangle                 | 1.0.0 |
| REVUPMediaTnkPub                 | 1.0.0 |
| REVUPMediaVungle                 | 1.0.0 |
| REVUPMediaMax                    | 1.0.0 |
| REVUPMediaMaxAdapterAdManager    | 1.0.0 |
| REVUPMediaMaxAdapterAdMob        | 1.0.0 |
| REVUPMediaMaxAdapterAmazon       | 1.0.0 |
| REVUPMediaMaxAdapterBidMachine   | 1.0.0 |
| REVUPMediaMaxAdapterBigo         | 1.0.0 |
| REVUPMediaMaxAdapterChartBoost   | 1.0.0 |
| REVUPMediaMaxAdapterDTExchange   | 1.0.0 |
| REVUPMediaMaxAdapterFan          | 1.0.0 |
| REVUPMediaMaxAdapterInMobi       | 1.0.0 |
| REVUPMediaMaxAdapterIronSource   | 1.0.0 |
| REVUPMediaMaxAdapterLine         | 1.0.0 |
| REVUPMediaMaxAdapterMobVista     | 1.0.0 |
| REVUPMediaMaxAdapterMoloco       | 1.0.0 |
| REVUPMediaMaxAdapterOgury        | 1.0.0 |
| REVUPMediaMaxAdapterPangle       | 1.0.0 |
| REVUPMediaMaxAdapterPubMatic     | 1.0.0 |
| REVUPMediaMaxAdapterUnityAds     | 1.0.0 |
| REVUPMediaMaxAdapterVungle       | 1.0.0 |
...
```
```html
https://github.com/revup-tnk/REVUPMediaMaxAdapterAmazon-SPM.git
```
```html
